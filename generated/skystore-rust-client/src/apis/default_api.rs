...
/// struct for typed errors of method [`locate_bucket_status`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LocateBucketStatusError {
    Status404(),
    Status422(crate::models::HttpValidationError),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`locate_object_status`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn locate_bucket_status(configuration: &configuration::Configuration, locate_bucket_request: crate::models::LocateBucketRequest) -> Result<crate::models::BucketStatus, Error<LocateBucketStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/locate_bucket_status", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LocateBucketStatusError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn locate_object(configuration: &configuration::Configuration, locate_object_request: crate::models::LocateObjectRequest) -> Result<crate::models::LocateObjectResponse, Error<LocateObjectError>> {
    println!("we reach location object inernally");
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;
    println!("configuration {:?}", configuration);
    println!("locate_object_request {:?}", locate_object_request);
    let local_var_uri_str = format!("{}/locate_object", local_var_configuration.base_path);
    println!("location object inernally local_var_uri_str {:?}", local_var_uri_str);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if local_var_status.is_client_error(){
        println!("client errror !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    } 
    if local_var_status.is_server_error(){
        println!("server errror !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    }
    println!("not server not client\n");
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        serde_json::from_str(&local_var_content).map_err(Error::from)
    } else {
...
pub async fn locate_object_status(configuration: &configuration::Configuration, locate_object_request: crate::models::LocateObjectRequest) -> Result<crate::models::ObjectStatus, Error<LocateObjectStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/locate_object_status", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LocateObjectStatusError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
