...
def create_instance(
    ...
    # validate arguments
    aws_region_list = ["eu-west-2"]
    init_regions_list = ['aws:ap-northeast-2', 
                         'aws:us-west-1', 
                         'aws:eu-central-2', 
                         'aws:ap-southeast-3', 
                         'aws:eu-north-1', 
    ...
    def setup(server: compute.Server):
        ...
        server.run_command(
            ...
            git clone https://github.com/shaopu1225/skystore.git; cd skystore/store-server; git switch large-scale-experiments; \
